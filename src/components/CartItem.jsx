    ...
    return (
        <div className="w-2/3 pr-10 flex flex-col" >
            ...
            <button
                ...
                className="w-32 bg-red-500 text-white mt-8 ml-7 py-1 px-6 hover:bg-red-800">
                Reset Cart
            </button>
            <Link to="/">
                <button className="w-32 mt-8 ml-7 flex flex-row items-center gap-1 text-gray-400 hover:text-black duration-300">
                    <span>
                        <HiOutlineArrowLeft />
                    </span>
                    go shopping
