                ...
                <div className="flex items-center gap-8">
                    ...
                    <Link to="/cart">
                        <div className="relative">
                            ...
                            <span className="absolute w-6 top-2 left-0.5 text-red-500 text-sm flex items-center justify-center font-semibold ">{productData.length}</span>
                        </div>
                    </Link>
                    <MdShoppingCartCheckout className="w-8 h-8 hover:text-red-600 cursor-pointer duration-300 rounded-full" />
                </div>
            </div>
